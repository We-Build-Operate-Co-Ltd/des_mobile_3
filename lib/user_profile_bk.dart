...
import 'package:des/user_profile_setting_bk.dart';
...
class UserProfileBkPage extends StatefulWidget {
  UserProfileBkPage({
    Key? key,
    this.changePage,
  }) : super(key: key);
  late _UserProfileBkPageState UserProfileBkPageState;
  Function? changePage;

  @override
  State<UserProfileBkPage> createState() => _UserProfileBkPageState();

  getState() => UserProfileBkPageState;
}

class _UserProfileBkPageState extends State<UserProfileBkPage> {
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => UserProfileSettingBkPage(),
                          ),
                        );
                      },
                      child: Container(
