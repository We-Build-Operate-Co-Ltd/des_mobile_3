...
class MyClassAllBkPage extends StatefulWidget {
  MyClassAllBkPage({Key? key, this.title}) : super(key: key);

  final title;

  @override
  _MyClassAllBkPageState createState() => _MyClassAllBkPageState();
}

class _MyClassAllBkPageState extends State<MyClassAllBkPage> {
  Dio dio = Dio();
