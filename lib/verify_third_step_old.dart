...
class VerifyThirdStepOldPage extends StatefulWidget {
  const VerifyThirdStepOldPage({Key? key, this.model}) : super(key: key);
  final dynamic model;

  @override
  State<VerifyThirdStepOldPage> createState() => _VerifyThirdStepOldPageState();
}

class _VerifyThirdStepOldPageState extends State<VerifyThirdStepOldPage> {
