...
class ForgotPasswordOTPPhonePage extends StatefulWidget {
  const ForgotPasswordOTPPhonePage({
    Key? key,
    required this.token,
  ...
  @override
  State<ForgotPasswordOTPPhonePage> createState() =>
      _ForgotPasswordOTPPhonePageState();
}

class _ForgotPasswordOTPPhonePageState
    extends State<ForgotPasswordOTPPhonePage> {
